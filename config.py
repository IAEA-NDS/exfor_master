...
GIT_REPO_PATH = "./"  # here
# GIT_REPO_PATH = "/Users/okumuras/Documents/nucleardata/EXFOR/exfor_master_test/"  # Fork

GIT_REPO_URL = "https://api.github.com/repos/IAEA-NDS/exfor_master/releases"
# GIT_REPO_URL = "https://api.github.com/repos/shinokumura/exfor_master_test/releases" # Fork
